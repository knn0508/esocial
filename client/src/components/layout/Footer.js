        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 text-sm max-w-md">
              ...
              sharing, and networking in the education and career ecosystem.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/home" className="text-sm text-gray-600 hover:text-primary-600">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/groups" className="text-sm text-gray-600 hover:text-primary-600">
                  Groups
                </Link>
              </li>
              <li>
                <Link to="/messages" className="text-sm text-gray-600 hover:text-primary-600">
                  Messages
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button type="button" className="text-sm text-gray-600 hover:text-primary-600 text-left">
                  Help Center
                </button>
              </li>
              <li>
